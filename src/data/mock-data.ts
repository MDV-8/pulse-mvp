...
export const aiChatResponses: Record<string, string> = {
  ...
  help:
    'Я ваш AI-ассистент PULSE 💜 Вот что я умею:\n\n• **Анализ продаж** — почему упали/выросли, прогнозы\n• **Финансы** — прибыль, расходы, маржинальность\n• **Средний чек** — рекомендации по увеличению\n• **Возврат клиентов** — кто ушёл и как вернуть\n• **Акции** — какая акция выгоднее для вашего бизнеса\n• **Аудитория** — кто ваши клиенты и что они покупают\n• **Конкуренты** — анализ рынка вокруг вас\n• **Лояльность** — программа бонусов и уровни\n\nПросто спросите меня!',
  competitors:
    'Анализ конкурентного окружения «Coffee & Co» в радиусе 1 км:\n\n**Основные конкуренты:**\n1. **Bean & Brew** — 350м, рейтинг 4.6\n   Средний чек: 4 800₸, фокус на авторский кофе\n2. **Cup & Cake** — 500м, рейтинг 4.3\n   Средний чек: 3 900₸, фокус на десерты\n3. **Koffee KZ** — 700м, рейтинг 4.1\n   Средний чек: 4 200₸, сеть из 5 точек\n\n**Ваши преимущества:**\n• Средний чек выше на 13%\n• Рейтинг 4.8 — лучший в районе\n• 87% клиентов возвращаются\n\n**Риски:**\n• Koffee KZ открыл новую точку рядом (−5% трафика)\n• Cup & Cake запустил агрессивную акцию (−3%)\n\nРекомендация: усилить программу лояльности и запустить реферальную кампанию',
  loyalty:
    'Текущая программа лояльности «Coffee & Co»:\n\n**Уровни:**\n• Бронза — 0–999 баллов (1₸ = 1 балл)\n• Серебро — 1 000–2 499 баллов (1.5₸ = 1 балл)\n• Золото — 2 500+ баллов (2₸ = 1 балл)\n\n**Статистика:**\n• Всего участников: 847\n• Активных за месяц: 412 (49%)\n• Средний баланс: 1 120 баллов\n• Обменяли за месяц: 156 000₸\n\n**Что можно улучшить:**\n1. Добавить экскилюзивные предложения для уровня Золото\n2. Ввести «двойные баллы» в дни низкого трафика (вт, ср)\n3. Партнёрская программа с соседними бизнесами\n\nПрогноз: оптимизация программы может увеличить повторные покупки на 12–18%',
  thanks:
    'Всегда рад помочь! 💜\n\nЕсли у вас появятся новые вопросы по бизнесу — обращайтесь в любой момент. Я анализирую ваши данные в реальном времени и готов помочь с рекомендациями.',
};
